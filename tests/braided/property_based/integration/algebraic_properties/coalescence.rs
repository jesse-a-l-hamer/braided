...
//     test_runner
//         .run(
//             &valid::coalescence::test_cases::coalesce_band(None, None, None),
//             |test_case| {
...
//     test_runner
//         .run(
//             &valid::coalescence::test_cases::coalesce_word(Some(20), Some(20), Some(20), true),
//             |test_case| {
//                 let data = test_case.data.0;
//                 let expected = test_case.expected;
//
...
//     test_runner
//         .run(
//             &valid::coalescence::test_cases::coalesce_braid(Some(20), Some(20), Some(20), true),
//             |test_case| {
//                 let data = test_case.data.0;
//                 let expected = test_case.expected;
//
